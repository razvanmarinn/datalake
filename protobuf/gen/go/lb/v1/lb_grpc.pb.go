...
const (
	LBService_GetWorkerID_FullMethodName = "/lb.v1.LBService/GetWorkerID"
)
...
type LBServiceClient interface {
	GetWorkerID(ctx context.Context, in *GetWorkerIDRequest, opts ...grpc.CallOption) (*GetWorkerIDResponse, error)
}
...
func (c *lBServiceClient) GetWorkerID(ctx context.Context, in *GetWorkerIDRequest, opts ...grpc.CallOption) (*GetWorkerIDResponse, error) {
...
type LBServiceServer interface {
	GetWorkerID(context.Context, *GetWorkerIDRequest) (*GetWorkerIDResponse, error)
...
func (UnimplementedLBServiceServer) GetWorkerID(context.Context, *GetWorkerIDRequest) (*GetWorkerIDResponse, error) {
...
func _LBService_GetWorkerID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LBServiceServer).GetWorkerID(ctx, req.(*GetWorkerIDRequest))
	}
